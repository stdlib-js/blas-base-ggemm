...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-ggemm/tags). For example,
...
```javascript
var ggemm = require( 'path/to/vendor/umd/blas-base-ggemm/index.js' )
```
